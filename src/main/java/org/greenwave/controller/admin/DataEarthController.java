...
@Controller
public class DataEarthController {
	...
	@RequestMapping("/dataExportEarth")
	public String export(Map<String, Object> model, HttpSession session, ExportDataForm exportDataForm) {
		...
		System.out.println(dd[2]);//NOT CONCIDERING BY REqUEST
		List<String> ot_measures = measBusiness.listDataTypeByDomainAndCategory("OTHER_SUBSTANCES",dd[2]);
		List<String> po_measures = measBusiness.listDataTypeByDomainAndCategory("POLLUTING_SUBSTANCES",dd[2]);
		...
		return "/admin/data/exportEarth";
	}
	
	@RequestMapping("/dataExportEarthValidate")
	...
	@RequestMapping("/mapInteractiveEarth")
	public String interactiveMap(Map<String, Object> model, HttpSession session, DateForm dateForm) {
		...
		model.put("username", username);
		DataDomain[] dd = DataDomain.values();
		List<Data> datas_tab = dataBusiness.findLastDataPerCoords(dd[2]);
		
		List<String> ot_measures = dataMeasuresBusiness.listDataTypeByDomain(dd[2]);
		...
		return "/admin/map/interactiveEarth";
	}
	
	@RequestMapping("/mapChangeEarth")
	public String changeMap(Map<String, Object> model, HttpSession session, DateForm dateForm) {
		...
		try{
			...
			DataDomain[] dd = DataDomain.values();
			List<Data> datas_tab = dataBusiness.findBetweenDate(sDate, eDate,dd[2]);
			List<String> ot_measures = dataMeasuresBusiness.listDataTypeByDomain(dd[2]);
	...
	public String apiSend(Map<String, Object> model, HttpSession session,ChartForm chartDateForm) {
		...
		typesPolluting =  dataMeasuresBusiness.listDataTypeByDomainAndCategory("POLLUTING_SUBSTANCES", dd[2]);

		List<String> typesClassics= new ArrayList<String>();
		typesClassics = dataMeasuresBusiness.listDataTypeByDomainAndCategory("OTHER_SUBSTANCES", dd[2]);
		...
		List<DataCategory> cat= DataCategoryBusiness.findByDomain(dd[2]);
		model.put("type",cat);
		
		return "/admin/charts/chartsEarth";
	}
	
	@RequestMapping("/changeEarthCharts")
